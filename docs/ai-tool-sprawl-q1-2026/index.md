...
Cross-organization measurement of AI tool inventory, approval posture, privilege surface, and regulatory exposure.
...
- Gait (reference in recommendations): https://github.com/Clyra-AI/gait
